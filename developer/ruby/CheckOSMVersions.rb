...
openstudiocore_cmake_path = File.join(ROOT_DIR, 'openstudio/CMakeLists.txt')
os_version_str = parse_version_from_cmakelist(openstudiocore_cmake_path)
puts "openstudio/CMakeLists.txt has OpenStudio at version #{os_version_str}"
