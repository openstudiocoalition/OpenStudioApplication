...
set(OPENSTUDIO_VERSION_PRERELEASE "-rc3")
# Enter SHA, always, eg "+79857912c4"
set(OPENSTUDIO_VERSION_SHA "+7d1f8bdb36")
...
if(APPLE)
  ...
  if(ARCH MATCHES "arm64")
    set(OPENSTUDIO_EXPECTED_HASH 37d5d0aa39a53d510ef80ff20cd259ab)
  else()
    set(OPENSTUDIO_EXPECTED_HASH 5dca5e48f72c59752cb1ff69bc096e92)
  endif()
...
elseif(UNIX)
  ...
  if(LSB_RELEASE_VERSION_SHORT MATCHES "24.04")
    ...
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH d34cc5bc2852b2ddbdcfb59aad875a37)
    else()
      set(OPENSTUDIO_EXPECTED_HASH ac2e2a7bc2659211425e60cdd703ce67)
    endif()
  elseif(LSB_RELEASE_VERSION_SHORT MATCHES "22.04")
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH bc9671271df500b488fa72a138d0c3d3)
    else()
      set(OPENSTUDIO_EXPECTED_HASH de7c9fcfd5398a3726757ad7cf7c4fa3)
    endif()
  elseif(LSB_RELEASE_ID_SHORT MATCHES "AlmaLinux")
    if (ARCH MATCHES "arm64")
      message(FATAL_ERROR "OpenStudio SDK for AlmaLinux is only built for x86_64")
    endif()
    set(OPENSTUDIO_EXPECTED_HASH 7fb41aab9c9eadb1018a87c5cd171d3b)
  else()
    message(FATAL_ERROR "OpenStudio SDK no longer provides packages for Ubuntu 20.04 or older")
  endif()

elseif(WIN32)
  set(OPENSTUDIO_EXPECTED_HASH bb4c6429e35e9ecbbbea015c1a1ef48a)
