...
set(OPENSTUDIO_VERSION_SHA "+15d1db6e7a")
...
if(APPLE)
  ...
  if(ARCH MATCHES "arm64")
    set(OPENSTUDIO_EXPECTED_HASH 4a8cf2cde586d8eb0c05b3ae0c341f10)
  else()
    set(OPENSTUDIO_EXPECTED_HASH b44431453b8e70f99afe16df8a36591d)
  endif()
...
elseif(UNIX)
  ...
  if(LSB_RELEASE_VERSION_SHORT MATCHES "24.04")
    ...
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH dec992baae0e8655c3a73fec0d3ba7d0)
    else()
      set(OPENSTUDIO_EXPECTED_HASH 4c2bc50d72ca6ea97bb0d0e5a597bf97)
    endif()
  elseif(LSB_RELEASE_VERSION_SHORT MATCHES "22.04")
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH TODO_MISSING)
    else()
      set(OPENSTUDIO_EXPECTED_HASH 6f48484d39ff7140f25ea34eb31a8c42)
    endif()
  elseif(LSB_RELEASE_ID_SHORT MATCHES "AlmaLinux")
    if (ARCH MATCHES "arm64")
      message(FATAL_ERROR "OpenStudio SDK for AlmaLinux is only built for x86_64")
    endif()
    set(OPENSTUDIO_EXPECTED_HASH 87fe0c8440bb8f26002aa86ba30802de)
  else()
