...
set(OPENSTUDIO_VERSION_SHA "+860f5de185")
...
if(APPLE)
  ...
  if(ARCH MATCHES "arm64")
    set(OPENSTUDIO_EXPECTED_HASH 1bef3479c673a38e4502e7f0d4cff0f1)
  else()
    set(OPENSTUDIO_EXPECTED_HASH d229a509056d2600553dd43ea3d060b6)
  endif()
...
elseif(UNIX)
  ...
  if(LSB_RELEASE_VERSION_SHORT MATCHES "22.04")
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH b38a57898b82ecbaa78b63098d34aad2)
    else()
      set(OPENSTUDIO_EXPECTED_HASH 73d2e87ad8a9692fc4caab466ce24c37)
    endif()
  elseif(LSB_RELEASE_VERSION_SHORT MATCHES "20.04")
    set(OPENSTUDIO_EXPECTED_HASH 5e76df1fd19c3503cb2f2d102fe130c2)
  else()
    message(FATAL_ERROR "OpenStudio SDK no longer provides packages for Ubuntu 18.04")
  endif()

elseif(WIN32)
  set(OPENSTUDIO_EXPECTED_HASH ba3f9d19df53ec17d2e70ba177d0d565)
