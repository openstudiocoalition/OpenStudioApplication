...
set(OPENSTUDIO_VERSION_SHA "+0aa781eed9")
...
elseif(UNIX)
  if(LSB_RELEASE_VERSION_SHORT MATCHES "20.04")
    set(OPENSTUDIO_EXPECTED_HASH e28d17485fa9da8185d0dff4194d741b)
    set(OPENSTUDIO_PLATFORM "Ubuntu-20.04")
  else() # Assumes 18.04
    set(OPENSTUDIO_EXPECTED_HASH a58c5ce7ff6a23774429700b7f4913cb)
    set(OPENSTUDIO_PLATFORM "Ubuntu-18.04")
  endif()

elseif(WIN32)
  set(OPENSTUDIO_EXPECTED_HASH 8ad34274f8a1e3ab201f4db043e48fff)
