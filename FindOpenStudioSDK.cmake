...
set(OPENSTUDIO_VERSION_PRERELEASE "-rc5")
# Enter SHA, always, eg "+79857912c4"
set(OPENSTUDIO_VERSION_SHA "+e2e9b52d54")
...
if(APPLE)
  ...
  if(ARCH MATCHES "arm64")
    set(OPENSTUDIO_EXPECTED_HASH 02a6e5ab11e2ee1f57af01105a8970f4)
  else()
    set(OPENSTUDIO_EXPECTED_HASH c9dd0240dc6fdf88e5e2934c741b04cc)
  endif()
...
elseif(UNIX)
  ...
  if(LSB_RELEASE_VERSION_SHORT MATCHES "24.04")
    ...
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH TODO_TDB_TODO)
    else()
      set(OPENSTUDIO_EXPECTED_HASH 370d0a3b5897d4b6f8d0cda7018920a4)
    endif()
  elseif(LSB_RELEASE_VERSION_SHORT MATCHES "22.04")
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH TODO_TDB_TODO)
    else()
      set(OPENSTUDIO_EXPECTED_HASH 1cd225f30b76c590111ce76ff4aea171)
    endif()
  else()
...
elseif(WIN32)
  set(OPENSTUDIO_EXPECTED_HASH 49b4da4d6b6bb44746ec6a338f9d8765)
