...
set(OPENSTUDIO_VERSION_SHA "+211bb633b0")
...
if(APPLE)
  ...
  if(ARCH MATCHES "arm64")
    set(OPENSTUDIO_EXPECTED_HASH 6fc27e7db29192bde8380bf0ad6c17cb)
  else()
    set(OPENSTUDIO_EXPECTED_HASH 8d1f1f80138d5e6b83279a0036adc52d)
  endif()
...
elseif(UNIX)
  ...
  if(LSB_RELEASE_VERSION_SHORT MATCHES "22.04")
    if (ARCH MATCHES "arm64")
      set(OPENSTUDIO_EXPECTED_HASH b171bb62fa7e333e0de2cdcec8bd766e)
    else()
      set(OPENSTUDIO_EXPECTED_HASH 9732ae90a18cdea217bedd62e67ff61f)
    endif()
  elseif(LSB_RELEASE_VERSION_SHORT MATCHES "20.04")
    set(OPENSTUDIO_EXPECTED_HASH 5745f8947864b8167769c3e5536eb91c)
  else()
    message(FATAL_ERROR "OpenStudio SDK no longer provides packages for Ubuntu 18.04")
  endif()

elseif(WIN32)
  set(OPENSTUDIO_EXPECTED_HASH dfeb4aa90485db014600e4cd1a90385a)
