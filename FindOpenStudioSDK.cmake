...
set(OPENSTUDIO_VERSION_SHA "+fb391396ca")
...
if(APPLE)
  if(ARCH MATCHES "arm64")
    set(OPENSTUDIO_EXPECTED_HASH 3059c54ed616a902689852c7624f6efe)
    set(OPENSTUDIO_PLATFORM "Darwin-arm64")
  else()
    set(OPENSTUDIO_EXPECTED_HASH 4b1ac253ec8d49540f8f368b0726be94)
    set(OPENSTUDIO_PLATFORM "Darwin")
  endif()

elseif(UNIX)
  if(LSB_RELEASE_VERSION_SHORT MATCHES "20.04")
    set(OPENSTUDIO_EXPECTED_HASH bb63aac8fce77f9b457b5c015ad9f250)
    set(OPENSTUDIO_PLATFORM "Ubuntu-20.04")
  else() # Assumes 18.04
    set(OPENSTUDIO_EXPECTED_HASH 9da212928496df9af21f5fc15edb687e)
    set(OPENSTUDIO_PLATFORM "Ubuntu-18.04")
  endif()

elseif(WIN32)
  set(OPENSTUDIO_EXPECTED_HASH 85723477a0be2d82d81252a42cf995e6)
