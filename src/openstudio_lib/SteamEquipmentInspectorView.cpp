...
void SteamEquipmentDefinitionInspectorView::onSelectModelObject(const openstudio::model::ModelObject& modelObject) {
  detach();
  auto steamEquipmentDefinition = modelObject.cast<model::SteamEquipmentDefinition>();
...
void SteamEquipmentDefinitionInspectorView::attach(const openstudio::model::SteamEquipmentDefinition& steamEquipmentDefinition) {
  ...
  m_nameEdit->bind(*m_steamEquipmentDefinition,
                   ...
                   boost::optional<StringSetterOptionalStringReturn>(
                     std::bind(&model::SteamEquipmentDefinition::setName, m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)));

  // m_designLevelEdit->bind(steamEquipmentDefinition,"designLevel",m_isIP);
  m_designLevelEdit->bind(m_isIP, *m_steamEquipmentDefinition,
                          ...
                          boost::optional<DoubleSetter>(std::bind(
                            static_cast<bool (model::SteamEquipmentDefinition::*)(double)>(&model::SteamEquipmentDefinition::setDesignLevel),
                            m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)));
  ...
  m_wattsPerSpaceFloorAreaEdit->bind(
    m_isIP, *m_steamEquipmentDefinition,
    ...
    boost::optional<DoubleSetter>(
      std::bind(static_cast<bool (model::SteamEquipmentDefinition::*)(double)>(&model::SteamEquipmentDefinition::setWattsperSpaceFloorArea),
                m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)));

  // m_wattsPerPersonEdit->bind(steamEquipmentDefinition,"wattsperPerson",m_isIP);
  m_wattsPerPersonEdit->bind(m_isIP, *m_steamEquipmentDefinition,
                             OptionalDoubleGetter(std::bind(&model::SteamEquipmentDefinition::wattsperPerson, m_steamEquipmentDefinition.get_ptr())),
                             boost::optional<DoubleSetter>(std::bind(
                               static_cast<bool (model::SteamEquipmentDefinition::*)(double)>(&model::SteamEquipmentDefinition::setWattsperPerson),
                               m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)));
  ...
  m_fractionLatentEdit->bind(
    ...
    boost::optional<DoubleSetter>(
      std::bind(static_cast<bool (model::SteamEquipmentDefinition::*)(double)>(&model::SteamEquipmentDefinition::setFractionLatent),
                m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)),
  ...
  m_fractionRadiantEdit->bind(
    ...
    boost::optional<DoubleSetter>(
      std::bind(static_cast<bool (model::SteamEquipmentDefinition::*)(double)>(&model::SteamEquipmentDefinition::setFractionRadiant),
                m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)),
  ...
  m_fractionLostEdit->bind(
    ...
    boost::optional<DoubleSetter>(
      std::bind(static_cast<bool (model::SteamEquipmentDefinition::*)(double)>(&model::SteamEquipmentDefinition::setFractionLost),
                m_steamEquipmentDefinition.get_ptr(), std::placeholders::_1)),
    boost::optional<NoFailAction>(std::bind(&model::SteamEquipmentDefinition::resetFractionLost, m_steamEquipmentDefinition.get_ptr())), boost::none,
    boost::none,
