...
inline QString iddObjectDocUrl(const QString& iddTypeName) {
  ...
  static const QHash<QString, QString> urlMap{
    ...
    {"OS:RunPeriod",                            "group-location-climate-weather-file-access.html#runperiod"},
    ...
    {"OS:Material:AirGap",                                      "group-surface-construction-elements.html#materialairgap"},
    ...
    // Daylighting
    {"OS:Daylighting:Control",          "group-daylighting.html#daylightingcontrols-000"},
    ...
    {"OS:Lights",               "group-internal-gains-people-lights-other.html#lights-000"},
    ...
    {"OS:HotWaterEquipment",    "group-internal-gains-people-lights-other.html#hotwaterequipment"},
    ...
    {"OS:InternalMass",         "group-thermal-zone-description-geometry.html#internalmass"},
    ...
    {"OS:AirTerminal:SingleDuct:SeriesPIU:Reheat",              "group-air-distribution-equipment.html#airterminalsingleductseriespiureheat"},
    {"OS:AirTerminal:SingleDuct:InletSideMixer",                "group-air-distribution-equipment.html#airterminalsingleductmixer"},
    ...
    {"OS:AirTerminal:FourPipeInduction",                                   "group-air-distribution-equipment.html#airterminalsingleductconstantvolumefourpipeinduction"},
    ...
    {"OS:Coil:Heating:Fuel",                                                "group-heating-and-cooling-coils.html#coilheatinggas-000"},
    ...
    {"OS:Coil:Heating:FourPipeBeam",                                        "group-air-distribution-equipment.html#airterminalsingleductconstantvolumefourpipebeam"},
    ...
    {"OS:EvaporativeCooler:Direct:CelDekPad",           "group-evaporative-coolers.html#evaporativecoolerdirectceldekpad"},
    {"OS:EvaporativeCooler:Indirect:CelDekPad",         "group-evaporative-coolers.html#evaporativecoolerindirectceldekpad"},
    ...
    {"OS:OutdoorAir:Mixer",                 "group-air-distribution.html#outdoorairmixer"},
    ...
    {"OS:AirLoopHVAC:ZoneMixer",            "group-air-path.html#airloophvaczonemixer"},
    {"OS:AirLoopHVAC:ZoneSplitter",         "group-air-path.html#airloophvaczonesplitter"},
    {"OS:AirLoopHVAC:ReturnPlenum",         "group-air-path.html#airloophvacreturnplenum"},
    {"OS:AirLoopHVAC:SupplyPlenum",         "group-air-path.html#airloophvacsupplyplenum"},
    ...
    {"OS:SetpointManager:OutdoorAirReset",              "group-setpoint-managers.html#setpointmanageroutdoorairreset"},
    ...
    {"OS:SetpointManager:MultiZone:Heating:Average",    "group-setpoint-managers.html#setpointmanagermultizoneheatingaverage"},
    {"OS:SetpointManager:MultiZone:Cooling:Average",    "group-setpoint-managers.html#setpointmanagermultizonecoolingaverage"},
    ...
    {"OS:Chiller:Absorption:Direct",                "group-plant-equipment.html#chillerabsorption"},
    ...
    {"OS:HeatExchanger:FluidToFluid",                   "group-condenser-equipment.html#heatexchangerfluidtofluid"},
    ...
    {"OS:GroundHeatExchanger:Vertical",         "group-condenser-equipment.html#groundheatexchangersystem"},
    ...
    {"OS:WaterHeater:HeatPump",                     "group-water-heaters.html#waterheaterheatpumppumpedcondenser"},
    ...
    {"OS:PlantLoop",                                        "group-plant-condenser-loops.html#plantloop"},
    {"OS:CondenserLoop",                                    "group-plant-condenser-loops.html#condenserloop"},
    ...
    {"OS:AvailabilityManagerAssignmentList",                "group-air-distribution.html#availabilitymanagerassignmentlist"},
